 ...
 */
export async function hasConfiguredRepairModel({
  dshHome,
  ...
  if (!isRecord(settings) || !isRecord(credentials)) return false
  ...
  if (hasStoredProviderRecord(credentials, selection.provider) || hasCredentialHeader(profile)) return true
