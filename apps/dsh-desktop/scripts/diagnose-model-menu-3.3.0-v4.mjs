...
try {
  ...
  const input = directoryDialog.getByRole('textbox', { name: /编辑路径|Edit path/iu })
  ...
  const rootMenu = page.locator('[role="menu"]').last()
  await rootMenu.getByRole('menuitem').first().click()
