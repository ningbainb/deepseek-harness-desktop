...
Desktop 3.0.7 is the direct-start and automatic-repair release. New public integrations must use the 3.0 contracts and policies rather than infer behavior from the internal Electron implementation.
