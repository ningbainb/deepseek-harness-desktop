...
- 桌面测试为 630 项通过、2 项因本机未开启 Windows 符号链接权限而跳过、0 项失败；跳过项只覆盖文件符号链接逃逸场景，同类目录链接与路径约束测试已通过。
...
| 大小 | `201828254` 字节 |
| SHA-256 | `69010f5e9451f31e09f883af52a3306d1b6818cf6f487eb6bf6d88d6c290ef6b` |
