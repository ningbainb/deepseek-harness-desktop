...
export const relayZh = {
  ...
  errorCredentialUnavailable: '本机无法读取已保存的 Key，请重新授权后再刷新。',
  errorNotConfigured: '请先完成 bai 供应商配置。',
...
export const relayEn: Record<RelayLocaleKey, string> = {
  ...
  errorCredentialUnavailable: 'The saved Key is unavailable locally. Reauthorize before refreshing.',
  errorNotConfigured: 'Configure the bai provider first.',
