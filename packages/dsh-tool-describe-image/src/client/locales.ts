...
export const zh = {
  ...
  'card.title': '图像理解',
  'card.description': '配置用于识别和分析图片的模型与接口。',
  ...
  'field.baseURL': '接口地址',
  'field.interceptImageSend': '自动为文本模型处理图片',
  'field.interceptImageSend.hint': '开启后，文本模型通过图像理解工具读取图片；视觉模型直接接收原图。关闭后交由会话原样发送。',
...
export const en = {
  ...
  'card.description': 'Configure the model and endpoint used to recognize and analyze images.',
  ...
  'field.interceptImageSend': 'Handle images for text models',
  'field.interceptImageSend.hint': 'Text models use the image understanding tool; vision models receive original images. Turn off to send images through the conversation unchanged.',
