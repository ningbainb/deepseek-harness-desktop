...
export type ModelPreferencesCardProps = PropsRuntime<'settings.models.footer'> & PropsLocale<'model-preferences'> & PropsRenderSlots<'model-preferences.onboarding'> & ModelPreferencesCardFace;
