...
export function PersonalPromptCard(props) {
    ...
    return (_jsxs("section", { className: styles.card, "data-personal-prompt-card": "true", children: [_jsxs("header", { className: styles.header, children: [_jsxs("div", { children: [_jsx("h3", { className: styles.title, children: t('settings.title') }), _jsx("p", { className: styles.description, children: t('settings.description') })] }), _jsx("span", { className: dirty ? styles.dirty : styles.badge, children: dirty ? t('settings.unsaved') : saved ? t('settings.saved') : 'OK' })] }), _jsx("p", { className: styles.notice, children: t('settings.ownerNotice') }), !settingsSnapshot.writable && _jsx("p", { className: styles.notice, role: "status", children: t('settings.readonly') }), settingsSnapshot.status === 'loading' && _jsx("p", { className: styles.muted, role: "status", children: t('settings.loading') }), conflict && _jsx("p", { className: styles.error, role: "alert", children: t('settings.conflict') }), error && _jsx("p", { className: styles.error, role: "alert", children: error }), _jsxs("div", { className: styles.toolbar, children: [_jsxs("label", { className: styles.toggle, children: [_jsx("input", { type: "checkbox", checked: draftConfig.enabled, disabled: !settingsSnapshot.writable, onChange: event => { setDraftConfig(current => ({ ...current, enabled: event.target.checked })); setConfigDirty(true); setSaved(false); } }), t('settings.enabled')] }), _jsxs("label", { className: styles.toggle, children: [_jsx("span", { children: t('settings.active') }), _jsxs("select", { className: styles.activeSelect, value: draftConfig.activeProfileId ?? '', disabled: !settingsSnapshot.writable, onChange: event => { const next = setActivePromptProfile(draftConfig, event.target.value || undefined); setDraftConfig(next); setConfigDirty(true); setSaved(false); }, children: [_jsx("option", { value: "", children: t('settings.none') }), visibleProfiles.map(profile => _jsx("option", { value: profile.id, children: profile.name }, profile.id))] })] })] }), _jsxs("section", { children: [_jsxs("div", { className: styles.profileHeader, children: [_jsx("strong", { children: t('settings.profiles') }), _jsx("button", { type: "button", className: styles.button, disabled: !settingsSnapshot.writable || saving, onClick: create, children: t('settings.new') })] }), listedProfiles.length === 0 && _jsx("p", { className: styles.muted, children: t('settings.noProfiles') }), _jsx("div", { className: styles.profileList, role: "list", children: listedProfiles.map(profile => (_jsxs("button", { type: "button", role: "listitem", className: `${styles.profileButton} ${profile.id === selectedId ? styles.profileSelected : ''}`, onClick: () => selectProfile(profile.id), children: [_jsxs("span", { className: styles.profileMain, children: [_jsx("span", { className: styles.profileName, children: profile.name || profile.id }), _jsx("span", { className: styles.profileMeta, children: profile.scope === 'global' ? t('settings.global') : profile.scope === 'workspace' ? `${t('settings.workspace')} · ${profile.workspaceId}` : t('settings.session') })] }), _jsx("span", { className: styles.profileState, children: profile.enabled ? t('settings.enable') : t('settings.disable') })] }, profile.id))) })] }), editor !== undefined && editor.scope !== 'session' && (_jsxs("section", { className: styles.editor, "aria-label": t('settings.title'), children: [_jsxs("label", { className: styles.field, children: [_jsx("span", { className: styles.fieldLabel, children: t('settings.profileName') }), _jsx("input", { value: editor.name, maxLength: 128, disabled: readOnlySession, placeholder: t('settings.profileNamePlaceholder'), onChange: event => editEditor({ name: event.target.value }) })] }), _jsxs("label", { className: styles.field, children: [_jsx("span", { className: styles.fieldLabel, children: t('settings.scope') }), _jsxs("select", { value: editor.scope, disabled: readOnlySession, onChange: event => { const scope = event.target.value; editEditor({ scope, workspaceId: scope === 'workspace' ? editor.workspaceId : '', sessionId: scope === 'session' ? editor.sessionId : '' }); }, children: [_jsx("option", { value: "global", children: t('settings.global') }), _jsx("option", { value: "workspace", children: t('settings.workspace') }), _jsx("option", { value: "session", disabled: true, children: t('settings.session') })] })] }), editor.scope === 'workspace' && _jsxs("label", { className: styles.field, children: [_jsx("span", { className: styles.fieldLabel, children: t('settings.workspaceId') }), _jsx("input", { list: "personal-prompt-workspaces", value: editor.workspaceId, maxLength: 128, disabled: readOnlySession, placeholder: t('settings.workspaceIdPlaceholder'), onChange: event => editEditor({ workspaceId: event.target.value }) }), _jsx("datalist", { id: "personal-prompt-workspaces", children: workspaceItems.map(item => { const id = workspaceIdOf(item); return id === undefined ? null : _jsx("option", { value: id, children: item.title ?? item.path ?? id }, id); }) })] }), readOnlySession && _jsx("p", { className: styles.notice, children: t('settings.sessionReadonly') }), _jsxs("label", { className: styles.toggle, children: [_jsx("input", { type: "checkbox", checked: editor.enabled, disabled: readOnlySession, onChange: event => editEditor({ enabled: event.target.checked }) }), editor.enabled ? t('settings.enable') : t('settings.disable')] }), _jsxs("label", { className: styles.field, children: [_jsx("span", { className: styles.fieldLabel, children: t('settings.content') }), _jsx("textarea", { value: editor.content, maxLength: MAX_PROMPT_CONTENT_LENGTH, disabled: readOnlySession, placeholder: t('settings.contentPlaceholder'), onChange: event => editEditor({ content: event.target.value }) }), _jsxs("span", { className: styles.counter, children: [editor.content.length, " / ", MAX_PROMPT_CONTENT_LENGTH] })] }), _jsxs("div", { children: [_jsx("span", { className: styles.fieldLabel, children: t('settings.preview') }), preview ? _jsx("pre", { className: styles.preview, children: preview }) : _jsx("p", { className: styles.muted, children: t('settings.previewEmpty') })] }), _jsxs("footer", { className: styles.footer, children: [_jsx("button", { type: "button", className: styles.danger, disabled: !settingsSnapshot.writable || saving, onClick: remove, children: t('settings.delete') }), _jsx("button", { type: "button", className: styles.button, disabled: !dirty || saving, onClick: reload, children: t('settings.discard') }), _jsx("button", { type: "button", className: styles.primary, disabled: !dirty || saving || readOnlySession || !settingsSnapshot.writable, onClick: save, children: saving ? t('settings.loading') : t('settings.save') })] })] })), _jsxs("footer", { className: styles.actions, children: [_jsx("button", { type: "button", className: styles.button, disabled: saving, onClick: reload, children: t('settings.reload') }), _jsx("button", { type: "button", className: styles.primary, disabled: !dirty || saving || !settingsSnapshot.writable, onClick: save, children: t('settings.save') })] })] }));
}
