...
import {
  ...
  type ArtifactRecord,
  type RenderArtifactArgs,
} from './core/types.ts'
import { CHAT_ARTIFACTS_TOOL_NAME } from './invariant.ts'
 ...
 */
export const CHAT_ARTIFACTS_GUIDANCE =
  'You can use the render_artifact tool to place a safe visualization directly in the conversation. '
...
export function createArtifactRecord(args: RenderArtifactArgs): ArtifactRecord {
...
export function renderArtifactCallView(args: Pick<RenderArtifactArgs, 'title' | 'kind'>): GenericCallView {
  return {
    card: 'generic',
