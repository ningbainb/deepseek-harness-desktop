...
describe('Desktop Client SDK v1', () => {
  ...
  it('uses a narrow typed contract without exposing the preload bridge', async () => {
    ...
    expect(bridge.openExtensionDock).toHaveBeenNthCalledWith(3, { tab: 'plugins' })
    expect(bridge.openExtensionDock).toHaveBeenNthCalledWith(4, { tab: 'market' })
    expect(bridge.openExtensionDock).toHaveBeenNthCalledWith(5, { tab: 'skills' })
